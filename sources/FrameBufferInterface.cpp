...
FrameBufferInterface::FrameBufferInterface(TextureDatabase* _texture_database ,
                                        ...
                                        unsigned int* default_fbo ) : FrameBufferInterface(){
...
void FrameBufferInterface::initializeFrameBuffer(){   
    gl_framebuffer_object = new GLFrameBuffer(texture_dim->width , texture_dim->height , GLRenderBuffer::DEPTH24_STENCIL8 , default_framebuffer_pointer); 
