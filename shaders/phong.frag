...
vec3 getViewDirection() { return normalize(camera_position - vertex_fragment_fragment_position); }
...
/**************************************************************************************************************/
vec3 computeAmbientSpotLight(uint i) { return spot_light_struct[i].ambientColor; }

vec3 computeAmbientDirectionalLight(uint i) { return directional_light_struct[i].ambientColor; }

vec3 computeAmbientPointLight(uint i) { return point_light_struct[i].ambientColor; }
