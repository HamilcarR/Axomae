...
__device__ inline float dot(const float2 &vec1, const float2 &vec2)
{
...
__global__ void gpgpu_functions::irradiance_mapping::gpgpu_device_compute_diffuse_irradiance(float *D_result_buffer, cudaTextureObject_t texture, unsigned width, unsigned height, unsigned _width, unsigned _height, unsigned total_samples)
{
...
__host__ void gpgpu_functions::irradiance_mapping::gpgpu_kernel_call(void (*device_function)(float *, cudaTextureObject_t, unsigned, unsigned, unsigned, unsigned, unsigned),
