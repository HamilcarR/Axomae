...
namespace nova::material {
  ...
  class TexturePackSampler {
   ...
   public:
    ...
    ax_device_callable ax_no_discard glm::vec3 emissive(float u, float v, const texturing::texture_data_aggregate_s &sample_data) const {
      using namespace math::texture;
      if (tpack.emissive.get()) {
        glm::vec4 value = tpack.emissive.sample(u, v, sample_data);
        return {rgb_uint2float(value.r), rgb_uint2float(value.g), rgb_uint2float(value.b)};
      }
      return glm::vec3(0.f);
    }
    ...
    ax_device_callable ax_no_discard glm::vec4 albedo(float u, float v, const texturing::texture_data_aggregate_s &sample_data) const {
      ...
      if (tpack.albedo.get()) {
        ...
        return {rgb_uint2float(value.r), rgb_uint2float(value.g), rgb_uint2float(value.b), rgb_uint2float(value.a)};
      }
      return glm::vec4(1.f);
    }

    ax_device_callable ax_no_discard glm::vec3 metallic(float u, float v, const texturing::texture_data_aggregate_s &sample_data) const {
      using namespace math::texture;
    ...
    ax_device_callable ax_no_discard glm::vec3 roughness(float u, float v, const texturing::texture_data_aggregate_s &sample_data) const {
      using namespace math::texture;
    ...
    ax_device_callable ax_no_discard glm::vec3 normal(float u, float v, const texturing::texture_data_aggregate_s &sample_data) const {
      using namespace math::texture;
    ...
    ax_device_callable ax_no_discard glm::vec3 ao(float u, float v, const texturing::texture_data_aggregate_s &sample_data) const {
      using namespace math::texture;
      if (tpack.ao.get()) {
    ...
    ax_device_callable ax_no_discard glm::vec3 opacity(float u, float v, const texturing::texture_data_aggregate_s &sample_data) const {
      using namespace math::texture;
    ...
    ax_device_callable ax_no_discard glm::vec3 specular(float u, float v, const texturing::texture_data_aggregate_s &sample_data) const {
      using namespace math::texture;
