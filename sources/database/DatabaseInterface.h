...
class DatabaseInterface {
 public:
  ...
  ax_no_discard virtual U firstFreeId() const = 0;

  ax_no_discard virtual bool empty() const = 0;

  ax_no_discard virtual int size() const = 0;

  virtual void invalidateCaches() = 0;

  ax_no_discard virtual std::size_t getCacheSize(uint8_t *ptr) const = 0;

  ax_no_discard virtual std::size_t getCurrentCacheSize() const = 0;

  ax_no_discard virtual uint8_t *getCurrentCache() const = 0;
};
