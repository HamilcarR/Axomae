...
namespace nova::texturing {
  glm::vec3 sample_cubemap(const glm::vec3 &sample_vector, const EnvmapResourcesHolder *res_holder) {
  ...
  glm::vec3 sample_cubemap_plane(const glm::vec3 &sample_vector, const glm::vec3 &up_vector, const EnvmapResourcesHolder *res_holder) {
