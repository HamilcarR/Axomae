...
OBJECTS       = Kernel.o \
		...
		generated_files/TextureFactory.o \
...
generated_files/TextureFactory.o: sources/TextureFactory.cpp includes/TextureFactory.h \
		includes/Texture.h \
		includes/constants.h \
		includes/utils_3D.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o generated_files/TextureFactory.o sources/TextureFactory.cpp
