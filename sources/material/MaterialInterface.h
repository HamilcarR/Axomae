...
class MaterialInterface {
 public:
  ...
  virtual float getEmissiveFactor() const = 0;
  virtual void clean() = 0;
  virtual void initializeMaterial() = 0;
  virtual bool isTransparent() const = 0;
  virtual float getDielectricFactor() const = 0;
  virtual float getRoughnessFactor() const = 0;
  virtual float getTransmissionFactor() const = 0;
  virtual float getAnisotropyFactor() const = 0;
  virtual void setAnisotropyFactor(float factor) = 0;
  virtual void setAlphaFactor(float transparency_value) = 0;
  virtual float getAlphaFactor() const = 0;
  virtual Vec2f getRefractiveIndex() const = 0;
  ...
  virtual const TextureGroup &getTextureGroup() const = 0;
};
